    ...
    <header className="bg-white shadow-md sticky top-0 z-50">
      <div className="max-w-screen-xl mx-auto flex justify-between items-center p-4">
        ...
        <div className="hidden md:flex space-x-4">
          <button className="text-amber-800 font-medium border border-amber-800 px-4 py-1 rounded hover:bg-amber-800 hover:text-white">Login</button>
          <button className="bg-amber-800 text-white font-medium px-4 py-1 rounded hover:bg-amber-900">Sign Up</button>
        </div>
